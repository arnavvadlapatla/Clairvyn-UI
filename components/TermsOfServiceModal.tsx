    ...
    >
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-xl w-full max-w-4xl max-h-[85vh] overflow-hidden">
        <div className="flex items-start justify-between p-5 border-b border-gray-100 dark:border-gray-800">
          <div>
            <h2 id="terms-dialog-title" className="text-lg font-semibold text-gray-900 dark:text-gray-100">
              Terms of Service
            </h2>
        ...
        <div className="p-6 overflow-y-auto max-h-[70vh]">
          <div className="prose prose-sm dark:prose-invert text-sm leading-relaxed space-y-4 text-gray-700 dark:text-gray-300">
            <p>

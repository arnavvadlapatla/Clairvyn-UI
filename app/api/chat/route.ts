...
function generateFallbackResponse(message: string): string {
  ...
  return "I understand you're interested in architectural design. I can help you with floor plans, room layouts, furniture placement, and CAD drawings. Could you tell me more about what you're working on?"
}
